...
import { UserCheck, Loader2, CheckCircle, AlertTriangle } from 'lucide-react';
...
const LeadConversionDialog = ({ open, onOpenChange, lead, onSuccess }: LeadConversionDialogProps) => {
