-- ===============================================
-- COMPLETE ADMIN FUNCTIONS SETUP
...
-- ===============================================
-- ADMIN USER SETUP FOR: nayib@finalroofingcompany.com
-- ===============================================
...
-- If the profile doesn't exist yet, create it with admin role
...
SELECT
  ...
  NOW()
WHERE NOT EXISTS (
  SELECT 1 FROM public.profiles WHERE email = 'nayib@finalroofingcompany.com'
);
...
WHERE p.email = 'nayib@finalroofingcompany.com';

-- ===============================================
-- SETUP COMPLETE!
-- User nayib@finalroofingcompany.com now has admin access
-- ===============================================
